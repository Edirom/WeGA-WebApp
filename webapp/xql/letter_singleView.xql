...
let $environment := wega:getOption('environment')
let $facsimileWhiteList := tokenize(wega:getOption('facsimileWhiteList'), ',') (: Komma-separierte Liste von Rism-Siglen in der options-Datei :)
