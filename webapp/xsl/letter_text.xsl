<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:preserve-space
        elements="tei:p tei:dateline tei:closer tei:opener tei:hi tei:addrLine tei:persName tei:rs tei:workName tei:characterName tei:placeName tei:seg tei:l tei:head tei:salute"/>
