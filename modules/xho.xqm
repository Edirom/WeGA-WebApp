...
declare function xho:printProjectLinks($lang as xs:string) as element(xhtml:div) {
    ...
    <xhtml:div id="project">
        ...
        <xhtml:ul>
            ...
            <xhtml:li><xhtml:a href="{core:join-path-elements(($baseHref, $lang, replace(lang:get-language-string('editorialGuidelines-works',$lang), '\s', '_')))}">{lang:get-language-string('editorialGuidelines-works', $lang)}</xhtml:a></xhtml:li>
