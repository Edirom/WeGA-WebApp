            ...
            <div id="main">
                ...
                <div id="contentLeft">
                        <ul id="letterTabs" class="shadetabs">
                            <li><a href="functions/getAjax.xql?function=printTranscription&#38;id={$docID}&#38;lang={$lang}" class="selected" rel="letterFrame" title="{lang:get-language-string('tabTitle_transcription', $lang)}">{lang:get-language-string('textOfLetter',$lang)}</a></li>
                            <li><a href="functions/xmlPrettyPrint.xql?id={$docID}" rel="letterFrame" title="{lang:get-language-string('tabTitle_xml', $lang)}">XML</a></li>
                            <li>{if(exists($doc//tei:facsimile//tei:graphic) and $rightsAreOK) 
                                then <a href="functions/getImage.xql?id={$docID}&#38;lang={$lang}" rel="letterFrame" title="{lang:get-language-string('tabTitle_facsimile', $lang)}">{lang:get-language-string('facsimile',$lang)}</a>
                ...
                <div id="contentRight">
                    ...
                    <div class="nameList">
                        <h2>{lang:get-language-string('persons',$lang)}</h2>
                        <ul id="persons">
                            <!-- (:Wird onload gefüllt:) -->
