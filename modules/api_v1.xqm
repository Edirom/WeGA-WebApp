...
module namespace api="http://xquery.weber-gesamtausgabe.de/modules/api_v1";
...
declare variable $api:INVALID_PARAMETER := QName("http://xquery.weber-gesamtausgabe.de/modules/api_v1", "ParameterError");
declare variable $api:UNSUPPORTED_ID_SCHEMA := QName("http://xquery.weber-gesamtausgabe.de/modules/api_v1", "UnsupportedIDSchema");
